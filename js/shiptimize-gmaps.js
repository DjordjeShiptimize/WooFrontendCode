import ShiptimizeWidget from "./shiptimize-widget";
class ShiptimizeGmaps {
    constructor(options) {
        ...
        this.shiptimizeWidget = new ShiptimizeWidget(options);
    }
    ...
    getCarrierIconUrl(type, selected) {
        ...
        let selectedextension = typeof (this.carrier_icon_config[this.carrier_id]) != 'undefined' && this.carrier_icon_config[this.carrier_id].selectedState && selected
            ? '_s' : '';
        ...
        if (type && typeof (shiptimize_carrier_imgs) != 'undefined' && shiptimize_carrier_imgs.indexOf(this.carrier_id + "_" + type + file_extension)) {
...
export default ShiptimizeGmaps;
